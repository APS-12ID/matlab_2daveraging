function [count, filen]=specPE(specfilename, fileindex_str, flag)
% [count, filen]=specPE(specfilename, fileindex_str, flag)
% PE version of specSAXSn2.m
